...
using EdtechTest2.Models.ParkyMapper;
...
namespace EdtechTest2
{
    ...
    .AddDbContext<ApplicationDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));
            ...
            {
                options.AccessDeniedPath = new PathString("/Identity/AcessDenied/");
            ...
            services.Configure<GoogleFireStoreStorageSettings>(Configuration.GetSection("GoogleFireStoreStorage"));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseStaticFiles();
            app.UseAuthentication();// this is very impotant
            app.UseRouting();
